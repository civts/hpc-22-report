...
% objective
This research aims to study the implications of running an algorithm to solve the closest pair of points problem in parallel on a cluster for High Performance Computing\footnote{Source code available in \Cref{link:source}}.
